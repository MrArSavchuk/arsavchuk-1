...
// import icon_education from '../assets/icon_education.jpg'
// import icon_cv from '../assets/icon_cv.jpg'
...
//                 <h1>Hi, I'm <span className='name_span'>Artem Savchuk</span></h1>
//                 <h2>
...
//                     </span>
//                 </h2>
//                 <p>Helping companies transform their vision into impactful, user-friendly digital products.<br />
//                     Let’s bring your vision to life and turn ideas into interactive experiences.</p>
//                 <footer className='block_links'>
//                     {/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */}
//                     <a href="#" target="_blank" rel="noopener noreferrer">
//                         <img src={icon_education} alt="Facebook" />
//                     </a>
//                     <a href="https://github.com/MrArSavchuk" target="_blank" rel="noopener noreferrer">
//                         <img src={icon_github} alt="Github" />
//                     </a>
//                     <a href="mailto:mrarsavchuk@gmail.com">
//                         <img src={icon_mail} alt="Mail" />
//                     </a>
//                     <a href="#" target="_blank" rel="noopener noreferrer">
//                         <img src={icon_cv} alt="linkedin" />
//                     </a>
//                     {/* !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! */}
//                     <a href="#" target="_blank" rel="noopener noreferrer">
...
//                 <img src={image} alt="Photoportfolio" width="400px" />
//             </div>
